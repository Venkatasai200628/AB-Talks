...
const styles = {
  ...
  docTitle: { ...sansText(700, 14), color: color.ink },
  docSource: { flex: 'none', ...monoText(600, 11), color: color.accent },
  docBody: { ...sansText(400, 13, 1.45), color: color.muted, margin: '8px 0 0' },
  trap: {
    marginTop: 12,
    padding: '12px 14px',
